...
<body>
    ...
    <div class="content-page">
        <div class="container mt-2">
            <div class="row">
                <div class="col-lg-12 margin-tb">
                    <div class="pull-left mb-2">
                        <h2>Registre Orden de compra</h2>
                    </div>
                    <div class="pull-right">
                        <a class="btn btn-primary" href="{{ route('orden_compras') }}"> Regresar</a>
            ...
            @endif
            <form action="{{ route('orden_compras.guardar') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="cantidad" class="form-control" placeholder="producto">
                            @error('cantidad')
                                <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="producto" class="form-control" placeholder="costo">
                            @error('producto')
                                <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="autorizado" class="form-control" placeholder="evidencia">
                            @error('autorizado')
                                <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                            @enderror
                        </div>
