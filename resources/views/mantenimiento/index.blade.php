            ...
            <div class="row">
                ...
                <div class="col-lg-12 margin-tb">
                    ...
                    <div class="pull-right mb-2">
                        <a class="btn btn-success" href="{{ route('mantenimientos.crear') }}"> Registrar
                            Mantenimientos</a>
                ...
                @foreach ($mantenimientos as $mantenimiento)
                    <tr>
                        <tbody>
                            ...
                            <td>{{ $mantenimiento->nombre_proveedor }}</td>
                            <td>{{ $mantenimiento->marca }}</td>
                            <td>{{ $mantenimiento->id_vehiculo }}</td>
                        </tbody>
                        <form action="{{ route('mantenimientos.eliminar', $mantenimiento->id) }}" method="Post">
                            <a class="btn btn-primary"
                                href="{{ route('mantenimientos.editar', $mantenimiento->id) }}">Editar</a>
