...
<body>
    ...
    <div class="content-page">
        <div class="container mt-2">
            <div class="row">
                <div class="col-lg-12 margin-tb">
                    <div class="pull-left mb-2">
                        <h2>Registre Mantenimiento</h2>
                    </div>
                    <div class="pull-right">
                        <a class="btn btn-primary" href="{{ route('mantenimientos') }}"> Regresar</a>
            ...
            @endif
            <form action="{{ route('mantenimientos.guardar') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="id_vehiculo" class="form-control" placeholder="id_vehiculo">
