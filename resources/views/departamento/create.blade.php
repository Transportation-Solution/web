...
<body>
    ...
    <div class="content-page">
        <div class="container mt-2">
            <div class="row">
                <div class="col-lg-12 margin-tb">
                    <div class="pull-left mb-2">
                        <h2>Registre departamento</h2>
                    </div>
                    <div class="pull-right">
                        <a class="btn btn-primary" href="{{ route('departamentos') }}"> Regresar</a>
                    </div>
                </div>
            </div>
            @if (session('status'))
            ...
            @endif
            <form action="{{ route('departamentos.guardar') }}" method="POST" enctype="multipart/form-data">
